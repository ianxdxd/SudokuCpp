        ...
        switch(menuChoice){
            case 1:
                ...
                while(jogoRodando){
                    ...
                    // Contador das jogadas(validas)
                    /*int counterJogadas = 0; */
                    ...
                    if(vitoria){
                        ...
                        cout << "Jogadas validas: " ;//<< counterJogadas << endl;
                        cout << " Dificuldade do jogo: " << difficultyChoice << endl;
                        jogoRodando = false;
                    }
                }
                break;
            ...
            case 3:
                ...
                cout << "Equipe de desenvolvimento: Lucas Losekann Rosa, Ian Callegari Aragao, ?? " << endl;
                cout << "Mes/Ano: Junho de 2023" << endl;
                cout << "Professora: Cristina Honorita" << endl;
